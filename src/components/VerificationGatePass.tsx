      ...
      <div className="no-print bg-white p-4 rounded-xl border border-stone-200 shadow-sm flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="inline-flex items-center gap-1.5 text-xs font-semibold text-stone-700 bg-stone-100 hover:bg-stone-200 px-3 py-2 rounded-lg transition-colors border border-stone-300"
          >
          ...
          <button
            onClick={handlePrint}
            className="inline-flex items-center gap-1.5 text-xs font-bold text-white bg-emerald-800 hover:bg-emerald-900 px-4 py-2 rounded-lg shadow-sm hover:shadow transition-all"
          >
          ...
          {participant.status === 'approved' && !participant.attendance.checkedIn && (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-bold text-emerald-950 bg-amber-400 hover:bg-amber-300 px-3.5 py-2 rounded-lg shadow-sm transition-all"
            >
          ...
          {participant.attendance.checkedIn && (
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-stone-700 bg-stone-100 hover:bg-red-50 hover:text-red-700 hover:border-red-300 px-3 py-2 rounded-lg transition-colors border border-stone-300"
            >
        ...
        <div className="no-print bg-amber-50 border-2 border-amber-300 rounded-xl p-4 animate-fade-in">
          ...
          <div className="mt-3 flex items-center gap-3">
            <input
              ...
              className="text-xs font-mono font-bold px-3 py-2 border border-amber-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 w-48"
            />
            <button
              onClick={handleGateCheckIn}
              className="text-xs font-bold bg-emerald-800 text-white px-4 py-2 rounded-lg hover:bg-emerald-900 transition-colors"
            >
